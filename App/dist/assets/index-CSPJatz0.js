import{i as p,a as u,R as f,M as b,b as d}from"./index-DYV5x_W9.js";import{n as g,r as m,c as M}from"./if-defined-DCVUMdR3.js";import{T as l}from"./index-Du-Tri5b.js";const T={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=i[0]||0,r=i[1]||0,t=e[0]||0,s=e[1]||0;return o<n?t:o>r?s:(s-t)/(r-n)*(o-n)+t}},v=p`
  :host {
    width: 100%;
    display: block;
  }
