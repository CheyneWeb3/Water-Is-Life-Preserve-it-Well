import{i as N,a as k,b as a,r as L,D as v,aj as p,t as O,R as Y,O as z,a2 as V,z as E,W}from"./index-DYV5x_W9.js";import{n as l,c as _,o as S,r as b}from"./if-defined-DCVUMdR3.js";import{T as A,D as F}from"./index-C0GsuTp6.js";import"./index-Dc77MzZp.js";import"./index-myT2kiCB.js";import"./index-DECD60AZ.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
