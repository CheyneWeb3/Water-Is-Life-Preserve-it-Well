import{i as T,a as w,b as c,aR as J,aY as l,aj as N,aQ as x,z as S,O as j,M as I,D as O,E as Z,a2 as G,W as H,R as U,t as V,a5 as M,a0 as Q,q as ee,S as L,T as te}from"./index-DYV5x_W9.js";import{n as d,c as g,o as h,r as u}from"./if-defined-DCVUMdR3.js";import{D as ie,T as re}from"./index-C0GsuTp6.js";import"./index-Dc77MzZp.js";import"./index-DECD60AZ.js";import"./index-BGzr0PwH.js";import"./index-BbBRuVmB.js";import{O as z}from"./index-9yuc1XSx.js";import"./index-b8LTkaLt.js";import"./index-myT2kiCB.js";import"./index-BTaMbO1G.js";import"./index-BzabmC56.js";import"./index-DyNjo7Me.js";import"./index-BhKTDXf4.js";import"./ref-XGXaEEtr.js";import"./index-BR_GCMwY.js";import"./ConstantsUtil-Dmg8YACJ.js";const oe=T`
  :host {
    width: 100%;
  }
...
`;var W=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const ne=7;let P=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=l.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=N.state.coinbaseTransactions,this.tokenImages=x.state.tokenImages,this.unsubscribe.push(l.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),x.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},N.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),N.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var B=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let A=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.paymentCurrency,this.currencies=l.state.paymentCurrencies,this.currencyImages=x.state.currencyImages,this.checked=z.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),x.subscribeKey("currencyImages",e=>this.currencyImages=e),z.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=j.state,r=(n=j.state.features)==null?void 0:n.legalCheckbox,s=!!(e||t)&&!!r&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var r;return c`
      ...
      `})}selectCurrency(e){e&&(l.setPaymentCurrency(e),I.close())}};A.styles=ae;B([u()],A.prototype,"selectedCurrency",void 0);B([u()],A.prototype,"currencies",void 0);B([u()],A.prototype,"currencyImages",void 0);B([u()],A.prototype,"checked",void 0);A=B([g("w3m-onramp-fiat-select-view")],A);const ce=T`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var ue=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let Y=class extends w{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=j.state;return!e&&!t?null:c`
      <wui-flex
        .padding=${["m","s","s","s"]}
        flexDirection="column"
        alignItems="center"
    ...
    `}howDoesItWorkTemplate(){return c` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){var t;const e=O.state.activeChain;G.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:((t=S.state.preferredAccountTypes)==null?void 0:t[e])===H.ACCOUNT_TYPES.SMART_ACCOUNT}}),U.push("WhatIsABuy")}};Y.styles=[le];Y=ue([g("w3m-onramp-providers-footer")],Y);var X=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let K=class extends w{constructor(){super(),this.unsubscribe=[],this.providers=l.state.providers,this.unsubscribe.push(l.subscribeKey("providers",e=>{this.providers=e}))}firstUpdated(){const e=this.providers.map(async t=>t.name==="coinbase"?await this.getCoinbaseOnRampURL():Promise.resolve(t==null?void 0:t.url));Promise.all(e).then(t=>{this.providers=this.providers.map((r,o)=>({...r,url:t[o]||""}))})}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
...
`;var $=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const we={USD:"$",EUR:"€",GBP:"£"},ge=[100,250,500,1e3];let v=class extends w{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=O.state.activeCaipAddress,this.loading=I.state.loading,this.paymentCurrency=l.state.paymentCurrency,this.paymentAmount=l.state.paymentAmount,this.purchaseAmount=l.state.purchaseAmount,this.quoteLoading=l.state.quotesLoading,this.unsubscribe.push(O.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),I.subscribeKey("loading",e=>{this.loading=e}),l.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||I.open({view:"OnRampProviders"})}openModal(){I.open({view:"Connect"})}async onPaymentAmountChange(e){l.setPaymentAmount(Number(e.detail)),await l.getQuote()}async selectPresetAmount(e){l.setPaymentAmount(e),await l.getQuote()}};v.styles=fe;$([d({type:Boolean})],v.prototype,"disabled",void 0);$([u()],v.prototype,"caipAddress",void 0);$([u()],v.prototype,"loading",void 0);$([u()],v.prototype,"paymentCurrency",void 0);$([u()],v.prototype,"paymentAmount",void 0);$([u()],v.prototype,"purchaseAmount",void 0);$([u()],v.prototype,"quoteLoading",void 0);v=$([g("w3m-onramp-widget")],v);export{m as W3mBuyInProgressView,P as W3mOnRampActivityView,K as W3mOnRampProvidersView,A as W3mOnrampFiatSelectView,_ as W3mOnrampTokensView,v as W3mOnrampWidget,q as W3mWhatIsABuyView};
